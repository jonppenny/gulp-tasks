...
gulp.task('sass', function() {
    return gulp.src('./resources/assets/scss/**/*.scss') // Gets all files ending with .scss in ./resources/assets/scss and children dirs
        .pipe(sass()) // Passes it through a gulp-sass
        .pipe(gulp.dest('./resources/assets/css')) // Outputs it in the css folder
